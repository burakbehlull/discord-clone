...
const ChannelList : React.FC<ChannelListProp> = ({view, activeServer})=> {
	return (
		<>
			{view === 'server' && activeServer ? (
			  <div className="w-64 bg-discord-100 p-4 text-discord-600 flex flex-col space-y-2 overflow-y-auto">
				<div className="font-bold text-white text-xs tracking-wide uppercase mb-2">{activeServer.name}</div>
